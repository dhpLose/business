<template>
  <el-radio-group v-model="form[config.prop]" @change="handleChange">
    <el-radio v-for="item in option" :key="item[props.value]" :label="item[props.value]">{{ item[props.label]}}</el-radio>
  </el-radio-group>
</template>
<script>
export default {
